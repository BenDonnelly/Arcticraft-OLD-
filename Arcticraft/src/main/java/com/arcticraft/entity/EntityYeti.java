...
public class EntityYeti extends EntityMob implements AC_IBossDisplayData
{
	...
	protected void func_110147_ax()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.399D);

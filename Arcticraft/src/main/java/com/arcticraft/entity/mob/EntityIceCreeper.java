...
import com.arcticraft.entity.mob.ai.EntityAIIceShard;
import com.arcticraft.item.AC_Item;

public class EntityIceCreeper extends EntityCreeper implements IRangedAttackMob
{
	...
	private EntityAIIceShard aiIceShardAttack = new EntityAIIceShard(this, 1.0D, 20, 60, 15.0F);
	...
	public EntityIceCreeper(World par1World)
	{
		...
		this.tasks.addTask(7, new EntityAIIceShard(this, 1.0D, 20, 60, 15.0F));
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		...
		for(k = 0; k < j; ++k)
		{
			this.dropItem(AC_Item.IceShard, 1);
		}
	}

	public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLivingBase, float par2)
	{
		EntityIceShard AC_EntityIceShard = new EntityIceShard(this.worldObj, par1EntityLivingBase, par2);
		int i = EnchantmentHelper.getEnchantmentLevel(Enchantment.power.effectId, this.getHeldItem());
		int j = EnchantmentHelper.getEnchantmentLevel(Enchantment.punch.effectId, this.getHeldItem());
		AC_EntityIceShard.setDamage((double) (par2 * 2.0F) + this.rand.nextGaussian() * 0.25D +  this.worldObj.difficultySetting.getDifficultyId());

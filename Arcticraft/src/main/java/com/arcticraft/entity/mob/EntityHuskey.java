...
import com.arcticraft.entity.mob.ai.EntityAIHuskyBeg;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class EntityHuskey extends EntityTameable
{
    ...
    public EntityHuskey(World p_i1696_1_)
    {
        super(p_i1696_1_);
        ...
        this.tasks.addTask(8, new EntityAIHuskyBeg(this, 8.0F));
    ...
    public EntityHuskey createChild(EntityAgeable p_90011_1_)
    {
        EntityHuskey entitywolf = new EntityHuskey(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_)
    {
        ...
        else if (!(p_70878_1_ instanceof EntityHuskey))
        {
            return false;
        }
        else
        {
            EntityHuskey entitywolf = (EntityHuskey)p_70878_1_;
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityHuskey)
            {
                EntityHuskey entitywolf = (EntityHuskey)p_142018_1_;

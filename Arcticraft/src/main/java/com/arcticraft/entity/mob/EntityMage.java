...
public class EntityMage extends EntityAnimal
{
	...
	public boolean interact(EntityPlayer par1EntityPlayer)
	{
		...
		if(var2 != null && var2.getItem() == Item.getItemFromBlock(AC_Block.mysticalSnow))
		{
			...
			{
				par1EntityPlayer.dropPlayerItemWithRandomChoice(new ItemStack(AC_Item.MystFruit, 1, 0), false);
			}

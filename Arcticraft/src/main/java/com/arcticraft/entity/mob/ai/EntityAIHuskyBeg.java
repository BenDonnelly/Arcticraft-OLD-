...
public class EntityAIHuskyBeg extends EntityAIBase
{

	private EntityHuskey theHusky;
	private EntityPlayer thePlayer;
	private World worldObject;
	private float minPlayerDistance;
	private int field_75384_e;

	public EntityAIHuskyBeg(EntityHuskey par1EntityHusky, float par2)
	{
	...
	private boolean hasPlayerGotBoneInHand(EntityPlayer par1EntityPlayer)
	{
		...
		return itemstack == null ? false : (! this.theHusky.isTamed() && itemstack.getItem() == Items.bone ? true : this.theHusky.isBreedingItem(itemstack));
	}
}

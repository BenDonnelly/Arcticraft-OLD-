...
public class EntityNPickaxe extends EntityThrowable
{
    public EntityNPickaxe(World par1World)
    {
        super(par1World);
    }

    public EntityNPickaxe(World par1World, EntityLivingBase par2EntityLivingBase)
    {
        super(par1World, par2EntityLivingBase);
    }

    public EntityNPickaxe(World par1World, double par2, double par4, double par6)
    {

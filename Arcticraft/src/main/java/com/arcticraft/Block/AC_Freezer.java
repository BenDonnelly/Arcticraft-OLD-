...
public class AC_Freezer extends BlockContainer
{
    ...
    protected AC_Freezer(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Strings.MODID + ":freezer_side");
        this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? Strings.MODID + ":freezer_front_on" : Strings.MODID + ":freezer_front_off");
        this.field_149935_N = p_149651_1_.registerIcon(Strings.MODID + ":freezer_top");
    }
        ...
        {
            entityPlayer.openGui(MainRegistry.instance, 1, world, x ,y, z);
            return true;
        }
    ...
    public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, AC_Block.freezerBurning);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, AC_Block.freezerIdle);
        }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityFreezer)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
        	TileEntityFreezer tileentityfurnace = (TileEntityFreezer)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

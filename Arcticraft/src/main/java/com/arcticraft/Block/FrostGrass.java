...
public class FrostGrass extends Block implements IGrowable
{
    ...
    protected FrostGrass(Material material)
    {
        super(material);
    ...
    {
        return p_149691_1_ == 1 ? this.field_149991_b : (p_149691_1_ == 0 ? AC_Block.frostDirt.getBlockTextureFromSide(p_149691_1_) : this.blockIcon);
    }
        ...
        if (!p_149674_1_.isRemote)
        {
            ...
            else if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9)
            {
                for (int l = 0; l < 4; ++l)
                {
                    ...
                    if (p_149674_1_.getBlock(i1, j1, k1) == AC_Block.frostDirt && p_149674_1_.getBlockMetadata(i1, j1, k1) == 0 && p_149674_1_.getBlockLightValue(i1, j1 + 1, k1) >= 4 && p_149674_1_.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
                    {
                        p_149674_1_.setBlock(i1, j1, k1, AC_Block.frostGrass);
                    }
                }
            }
        }
    ...
    public IIcon getIcon(IBlockAccess p_149673_1_, int p_149673_2_, int p_149673_3_, int p_149673_4_, int p_149673_5_)
    {
        ...
        {
            return AC_Block.frostDirt.getBlockTextureFromSide(p_149673_5_);
        }
        else
        {
        ...
        while (l < 128)
        {
            ...
            while (true)
            {
                if (l1 < l / 16)
                {
                    ...
                    if (p_149853_1_.getBlock(i1, j1 - 1, k1) == AC_Block.frostGrass && !p_149853_1_.getBlock(i1, j1, k1).isNormalCube())
                    {
                        ++l1;
                        continue;
                    }

...
{
    public static final String[] field_149882_a = new String[] {"Glacier"};
    private static final String __OBFID = "CL_00000305";

    protected GlacierSapling()
    {
        float f = 0.4F;
    ...
    public void func_149878_d(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_)
    {
        ...
        Object object = p_149878_5_.nextInt(10) == 0 ? new WorldGenGlacierTrees(true) : new WorldGenGlacierTrees(true);
        int i1 = 0;
        int j1 = 0;
        boolean flag = false;
        ...
        switch (l)
        {
            ...
            case 1:
                ...
                if (!flag)
                {
                    j1 = 0;
                    i1 = 0;
                    object = new WorldGenGlacierTrees(true, 4 + p_149878_5_.nextInt(7), 3, 3, false);
                }

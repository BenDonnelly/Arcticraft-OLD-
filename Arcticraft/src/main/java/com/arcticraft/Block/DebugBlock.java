...
public class DebugBlock extends BlockBreakable {
	...
	public boolean func_150000_e(World p_150000_1_, int p_150000_2_, int p_150000_3_, int p_150000_4_) {
		DebugBlock.Size size = new DebugBlock.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
		DebugBlock.Size size1 = new DebugBlock.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_) {
		...
		DebugBlock.Size size = new DebugBlock.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
		DebugBlock.Size size1 = new DebugBlock.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
		if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null) {
			if (par5Entity instanceof EntityPlayerMP) {
				...
				if (par5Entity.dimension != MainRegistry.dimensionId) {
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, MainRegistry.dimensionId, new AC_Teleporter(thePlayer.mcServer.worldServerForDimension(MainRegistry.dimensionId)));
				} else {
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new AC_Teleporter(thePlayer.mcServer.worldServerForDimension(0)));
				}
			}
		}
	}
	...
	public static class Size {
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_) {
			...
			this.field_150863_d = DebugBlock.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = DebugBlock.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_) {
			...
			for (i1 = 0; i1 < 22; ++i1) {
				...
				if (block1 != Blocks.sandstone) {
					break;
				}
			}

			block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
			return block == Blocks.sandstone ? i1 : 0;
		}
		...
		protected int func_150858_a() {
			...
			for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g) {
				...
				for (j = 0; j < this.field_150868_h; ++j) {
					k = this.field_150861_f.posX + j * Direction.offsetX[DebugBlock.field_150001_a[this.field_150865_b][1]];
					l = this.field_150861_f.posZ + j * Direction.offsetZ[DebugBlock.field_150001_a[this.field_150865_b][1]];
					...
					if (j == 0) {
						block = this.field_150867_a.getBlock(k + Direction.offsetX[DebugBlock.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[DebugBlock.field_150001_a[this.field_150865_b][0]]);

						if (block != Blocks.sandstone) {
							break label56;
						}
					} else if (j == this.field_150868_h - 1) {
						block = this.field_150867_a.getBlock(k + Direction.offsetX[DebugBlock.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[DebugBlock.field_150001_a[this.field_150865_b][1]]);
			...
			for (i = 0; i < this.field_150868_h; ++i) {
				j = this.field_150861_f.posX + i * Direction.offsetX[DebugBlock.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[DebugBlock.field_150001_a[this.field_150865_b][1]];

				if (this.field_150867_a.getBlock(j, k, l) != Blocks.sandstone) {

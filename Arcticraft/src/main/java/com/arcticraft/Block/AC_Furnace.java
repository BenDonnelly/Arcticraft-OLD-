...
public class AC_Furnace extends BlockContainer {
	...
	protected AC_Furnace(boolean p_i45407_1_) {
		super(Material.rock);
		this.field_149932_b = p_i45407_1_;
	}

	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		return Item.getItemFromBlock(AC_Block.arcticFurnaceIdle);
	}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_.registerIcon(Strings.MODID + ":ac_furnace_side");
		this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? Strings.MODID + ":ac_furnace_front_on" : Strings.MODID + ":ac_furnace_front_off");
		this.field_149935_N = p_149651_1_.registerIcon(Strings.MODID + ":ac_furnace_top");
	}

	/**
	 * On right click, open the GUI. Return true if something happens, otherwise
	 * return false
	 */
	@Override
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityPlayer, int par1, float par2, float par3, float par4) {
		entityPlayer.openGui(MainRegistry.instance, 0, world, x, y, z);
		return true;
	}
	...
	public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_) {
		...
		if (p_149931_0_) {
			p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, AC_Block.arcticFurnaceBurning);
		} else {
			p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, AC_Block.arcticFurnaceIdle);
		}
	...
	public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_) {
		...
		if (p_149689_6_.hasDisplayName()) {
			((TileEntityArcticFurnace) p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
		}
	}

	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_) {
		if (!field_149934_M) {
			TileEntityArcticFurnace tileentityfurnace = (TileEntityArcticFurnace) p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

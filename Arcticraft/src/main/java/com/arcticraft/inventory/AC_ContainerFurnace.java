...
public class AC_ContainerFurnace extends Container
{
    private TileEntityArcticFurnace tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public AC_ContainerFurnace(InventoryPlayer par1InventoryPlayer, TileEntityArcticFurnace par2TileEntityFurnace)
    {

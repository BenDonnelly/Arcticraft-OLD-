...
{
    private static final ResourceLocation iceshard = new ResourceLocation(Strings.MODID + ":textures/projectiles/ice_shard.png");

    public void renderArrow(EntityIceShard par1AC_EntityIceShard, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation getEntityTexture(EntityIceShard par1AC_EntityIceShard)
    {
        return iceshard;
    }
    ...
    {
        return this.getEntityTexture((EntityIceShard)par1Entity);
    }
    ...
    {
        this.renderArrow((EntityIceShard)par1Entity, par2, par4, par6, par8, par9);
    }
}

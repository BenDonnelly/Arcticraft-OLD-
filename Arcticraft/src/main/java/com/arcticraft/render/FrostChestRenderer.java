...
public class FrostChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147505_d = new ResourceLocation(Strings.MODID + ":textures/blocks/frost_chest_double.png");
    private static final ResourceLocation field_147504_g = new ResourceLocation(Strings.MODID + ":textures/blocks/frost_chest.png");
    private ModelChest field_147510_h = new ModelChest();
    private ModelChest field_147511_i = new ModelLargeChest();
    private static final String __OBFID = "CL_00000965";

    public FrostChestRenderer()
    {
        
    }

    public void renderTileEntityAt(AC_TileEntityFrostChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof FrostChest && i == 0)
            {
                try
                {
                ((FrostChest)block).func_149954_e(p_147502_1_.getWorldObj(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
    ...
    {
        this.renderTileEntityAt((AC_TileEntityFrostChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}
...
public class AC_ModelHusky extends ModelBase
{
    ...
    {
       /* AC_EntityHusky AC_EntityHusky = (AC_EntityHusky)par1EntityLivingBase;

        if (AC_EntityHusky.isAngry())
        {
        ...
        this.wolfHeadMain.rotateAngleZ = AC_EntityHusky.getInterestedAngle(par4) + AC_EntityHusky.getShakeAngle(par4, 0.0F);
        this.wolfMane.rotateAngleZ = AC_EntityHusky.getShakeAngle(par4, -0.08F);
        this.wolfBody.rotateAngleZ = AC_EntityHusky.getShakeAngle(par4, -0.16F);
        this.wolfTail.rotateAngleZ = AC_EntityHusky.getShakeAngle(par4, -0.2F);*/
    }

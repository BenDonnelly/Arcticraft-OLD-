...
public class AC_GuiFurnace extends GuiContainer
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
    private TileEntityArcticFurnace tileFurnace;
    private static final String __OBFID = "CL_00000758";

    public AC_GuiFurnace(InventoryPlayer par1InventoryPlayer, TileEntityArcticFurnace par2TileEntityFurnace)
    {
        super(new AC_ContainerFurnace(par1InventoryPlayer, par2TileEntityFurnace));

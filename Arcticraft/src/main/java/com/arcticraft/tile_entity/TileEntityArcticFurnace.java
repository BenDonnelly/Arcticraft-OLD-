...
import com.arcticraft.Block.AC_Furnace;
import com.arcticraft.handler.AC_FurnaceRecipes;
...
public class TileEntityArcticFurnace extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.hasCustomInventoryName() ? this.field_145958_o : "Arctic Furnace";
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                AC_Furnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = AC_FurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);

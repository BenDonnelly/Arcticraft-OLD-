...
import com.arcticraft.Block.AC_Freezer;
...
public class TileEntityFreezer extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.hasCustomInventoryName() ? this.field_145958_o : "Freezer";
    }
    ...
    public void readFromNBT(NBTTagCompound p_145839_1_)
    {
        ...
        if (p_145839_1_.hasKey("Freezer", 8))
        {
            this.field_145958_o = p_145839_1_.getString("Freezer");
        }
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                AC_Freezer.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack itemstack = AC_FreezerRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
			if(itemstack == null)
				return false;

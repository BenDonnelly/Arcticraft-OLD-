...
public class AC_Teleporter extends Teleporter
{
    ...
    public AC_Teleporter(WorldServer par1WorldServer)
    {
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        {
            AC_Teleporter.PortalPosition portalposition = (AC_Teleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        else
        {
            for (l3 = l - short1; l3 <= l + short1; ++l3)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(l3, i2, l1) == AC_Block.debugBlock)
                        {
                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == AC_Block.debugBlock)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new AC_Teleporter.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == AC_Block.debugBlock)
            {
                i4 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == AC_Block.debugBlock)
            {
                i4 = 3;
            }
            ...
            for (i3 = -1; i3 <= 1; ++i3)
            {
                for (j3 = 1; j3 < 3; ++j3)
                {
                    for (k3 = -1; k3 < 3; ++k3)
                    {
                        ...
                        j4 = k2 + (j3 - 1) * l2 - i3 * l5;
                        flag = k3 < 0;
                        this.worldServerInstance.setBlock(l3, i4, j4, flag ? Blocks.sandstone : Blocks.air);
                    }
                }
            }
        }
        ...
        for (i3 = 0; i3 < 4; ++i3)
        {
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = -1; k3 < 4; ++k3)
                {
                    ...
                    this.worldServerInstance.setBlock(l3, i4, j4, (Block)(flag ? AC_Block.debugBlock : AC_Block.debugBlock), 0, 2);
                }
            }
    ...
    public void removeStalePortalLocations(long par1)
    {
        if (par1 % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                AC_Teleporter.PortalPosition portalposition = (AC_Teleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());

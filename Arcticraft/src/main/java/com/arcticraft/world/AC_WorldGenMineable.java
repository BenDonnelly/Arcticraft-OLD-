...
public class AC_WorldGenMineable extends WorldGenerator
{
	...
	public AC_WorldGenMineable(Block block, int j, int k)
	{
		this.minableBlockId = block;
		this.minableMetaId = k;
					...
					for(int var41 = var33; var41 <= var36; ++var41)
					{
						...
						if(var39 * var39 + var42 * var42 < 1.0D)
						{
							for(int var44 = var34; var44 <= var37; ++var44)
							{
								...
								if(var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && par1World.getBlock(var38, var41, var44) == AC_Block.frostStone)
								{

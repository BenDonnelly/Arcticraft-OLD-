...
public class AC_EntityAICavemanAttack extends EntityAIBase
{
	...
	public AC_EntityAICavemanAttack(EntityCreature par1EntityCreature, Class par2Class, double par3, boolean par5)
	{
		this(par1EntityCreature, par3, par5);
		this.classTarget = par2Class;
	}

	public AC_EntityAICavemanAttack(EntityCreature par1EntityCreature, double par2, boolean par4)
	{
	...
	public boolean shouldExecute()
	{
		...
		else if(AC_EntityCaveman.isAngry == false)
		{
			return false;
		}
		else
	...
	{
		EntityLivingBase entitylivingbase = this.attacker.getAttackTarget();
		return entitylivingbase == null ? false : (! entitylivingbase.isEntityAlive() ? false : (! this.field_75437_f ? ! this.attacker.getNavigator().noPath() : this.attacker.func_110176_b(MathHelper.floor_double(entitylivingbase.posX), MathHelper.floor_double(entitylivingbase.posY),
	...
	public void updateTask()
	{
		...
		if(attacker.isDead || !entitylivingbase.canEntityBeSeen(attacker))
		{

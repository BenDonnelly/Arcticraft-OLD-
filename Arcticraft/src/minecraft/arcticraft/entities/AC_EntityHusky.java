...
public class AC_EntityHusky extends EntityTameable
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(0.30000001192092896D);
	 ...
	 */
	public AC_EntityHusky spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	{
		AC_EntityHusky entitywolf = new AC_EntityHusky(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if(! (par1EntityAnimal instanceof AC_EntityHusky))
		{
			return false;
		}
		else
		{
			AC_EntityHusky entitywolf = (AC_EntityHusky) par1EntityAnimal;

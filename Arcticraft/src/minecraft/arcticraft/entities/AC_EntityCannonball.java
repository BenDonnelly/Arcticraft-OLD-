...
public class AC_EntityCannonball extends EntityThrowable
{

	public AC_EntityCannonball(World world)
	{
		super(world);
	}

	public AC_EntityCannonball(World world, EntityLivingBase living)
	{
		super(world, living);
	}

	public AC_EntityCannonball(World world, double d1, double d2, double d3)
	{

...
public class AC_Achievements
{
	...
	public static void initAchievements()
	{
		...
		AC_ENTER = new Achievement(40, "ENTER_AC", 0, 0, AC_Block.campfire, null).registerAchievement();
		BACK_TO_BASICS = new Achievement(41, "BACK_TO_BASICS", 2, 0, AC_Block.frostLog, AC_ENTER).registerAchievement();

...
public class AC_ClientProxy extends AC_CommonProxy {
	...
	public void reigsterRenderThings() {
		...
		RenderingRegistry.registerEntityRenderingHandler(AC_EntityEskimoChief.class, new AC_RenderCheifEskimo(new AC_ModelCheifEskimo(), 0.3F));
		RenderingRegistry.registerEntityRenderingHandler(AC_EntityEskimoHunter.class, new AC_RenderHunterEskimo(new AC_ModelHunterEskimo(), 0.3F));
		RenderingRegistry.registerEntityRenderingHandler(AC_EntityEskimo.class, new AC_RenderEskimo(new AC_ModelEskimo(), 0.3F));
		RenderingRegistry.registerEntityRenderingHandler(AC_EntityEskimoTrader.class, new AC_RenderTraderEskimo(new AC_ModelTraderEskimo(), 0.3F));
		RenderingRegistry.registerEntityRenderingHandler(AC_EntityEskimoChef.class, new AC_RenderChefEskimo(new AC_ModelChefEskimo(), 0.3F));

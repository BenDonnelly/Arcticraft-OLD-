...
public class AC_ContainerArcticFreezer extends Container
{
    private AC_TileEntityFreezer freezer;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public AC_ContainerArcticFreezer(InventoryPlayer par1InventoryPlayer, AC_TileEntityFreezer par2TileEntityFreezer)
    {
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.crafters.size(); ++i)
        {
            ...
            {
                icrafting.sendProgressBarUpdate(this, 0, this.freezer.freezerCookTime);
            }

            if (this.lastBurnTime != this.freezer.freezerBurnTime)
            {
                icrafting.sendProgressBarUpdate(this, 1, this.freezer.freezerBurnTime);
            }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (par2 != 1 && par2 != 0)
            {
                ...
                else if (AC_TileEntityFreezer.isItemFuel(itemstack1))
                {

...
public class AC_ContainerTresureChest extends Container
{

	private AC_TileEntityTresureChest chest;

	public AC_ContainerTresureChest(InventoryPlayer inventoryPlayer, AC_TileEntityTresureChest tileEntity)
	{
		chest = tileEntity;

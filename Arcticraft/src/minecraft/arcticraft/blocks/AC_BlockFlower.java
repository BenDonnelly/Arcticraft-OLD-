...
{
    public AC_BlockFlower(int par1, Material par2Material)
    {
    ...
    protected AC_BlockFlower(int par1)
    {
    ...
    {
        return par1 == MainRegistry.frostGrass.blockID || par1 == MainRegistry.frostDirt.blockID || par1 == Block.tilledField.blockID;
    }

...
public class AC_BlockFreezer extends BlockContainer
{
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		...
		this.field_94459_cP = par1IconRegister.registerIcon(this.isActive ? "AC:freezer_front_on" : "AC:freezer_front_off");
		this.field_94458_cO = par1IconRegister.registerIcon("AC:freezer_top");
	}
	...
	{
		return MainRegistry.freezerIdle.blockID;
	}
	...
	public static void updateFreezerBlockState(boolean par0, World par1World, int par2, int par3, int par4)
	{
		...
		if (par0)
		{
			par1World.setBlock(par2, par3, par4, MainRegistry.freezerBurning.blockID);
		}
		else
		{
			par1World.setBlock(par2, par3, par4, MainRegistry.freezerIdle.blockID);
		}

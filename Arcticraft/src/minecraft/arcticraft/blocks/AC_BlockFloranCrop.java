...
public class AC_BlockFloranCrop extends BlockFlower
{
	...
	public AC_BlockFloranCrop(int par1, int soilID, int soilMeta, int berryID, int berryMeta)
	{
		super(par1);
	...
	public AC_BlockFloranCrop(int id, int soilID, int berryID)
	{
		super(id);
	...
	public void updateTick(World world, int x, int y, int z, Random random)
	{
		...
		if (random.nextInt(25) == 0)
		{
			...
			{
				world.setBlock(x, y, z, world.getBlockMetadata(x, y, z) + 1);

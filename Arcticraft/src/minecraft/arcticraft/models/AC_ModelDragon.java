...
public class AC_ModelDragon extends ModelBase
{
    ...
    public AC_ModelDragon(float par1)
    {
    ...
    {
        GL11.glPushMatrix();
        AC_EntityDragon AC_EntityDragon = (AC_EntityDragon)par1Entity;
        float f6 = AC_EntityDragon.prevAnimTime + (AC_EntityDragon.animTime - AC_EntityDragon.prevAnimTime) * this.partialTicks;
        ...
        float f9 = 0.0F;
        float f10 = 1.5F;
        double[] adouble = AC_EntityDragon.getMovementOffsets(6, this.partialTicks);
        float f11 = this.updateRotations(AC_EntityDragon.getMovementOffsets(5, this.partialTicks)[0] - AC_EntityDragon.getMovementOffsets(10, this.partialTicks)[0]);
        float f12 = this.updateRotations(AC_EntityDragon.getMovementOffsets(5, this.partialTicks)[0] + (double)(f11 / 2.0F));
        f8 += 2.0F;
        ...
        for (int i = 0; i < 5; ++i)
        {
            double[] adouble1 = AC_EntityDragon.getMovementOffsets(5 - i, this.partialTicks);
        ...
        double[] adouble2 = AC_EntityDragon.getMovementOffsets(0, this.partialTicks);
        ...
        f14 = 60.0F;
        f9 = 0.0F;
        adouble = AC_EntityDragon.getMovementOffsets(11, this.partialTicks);

        for (int k = 0; k < 12; ++k)
        {
            adouble2 = AC_EntityDragon.getMovementOffsets(12 + k, this.partialTicks);

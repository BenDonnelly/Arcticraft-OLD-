...
public class AC_GuiMMButtons extends GuiButton
{

	public AC_GuiMMButtons(int i, int j, int k, String s)
	{
		super(i, j, k, s);
	}

	public AC_GuiMMButtons(int i, int j, int k, int l, int i1, String s)
	{
		super(i, j, k, l, i1, s);
		this.enabled = true;
	...
	public void drawButton(Minecraft minecraft, int i, int j)
	{
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(Strings.MOD_ID, "textures/gui/main_menu_buttons.png"));

...
public class AC_GuiCoordinates extends GuiScreen
{
	...
	public void drawScreen(int i, int j, float f)
	{
		...
		if(texture == 0)
		{
			FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(Strings.MOD_ID, "textures/gui/ac_default.png"));
			drawTexturedModalRect(k, l, 0, 0, 176, 166);
		}
		else if(texture == 1)
		{

			FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(Strings.MOD_ID, "textures/gui/bgtemp.png"));

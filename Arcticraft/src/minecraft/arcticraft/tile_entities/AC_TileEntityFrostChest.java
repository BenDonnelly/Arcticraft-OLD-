...
public class AC_TileEntityFrostChest extends TileEntity implements IInventory
{
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof AC_FrostChest ? ((AC_FrostChest)block).field_94443_a == this.func_98041_l() : false;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof AC_FrostChest)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int func_98041_l()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof AC_FrostChest))
            {
                return 0;
            }

            this.field_94046_i = ((AC_FrostChest)this.getBlockType()).field_94443_a;
        }

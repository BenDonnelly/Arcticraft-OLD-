...
import arcticraft.blocks.AC_BlockFrostChest;
...
public class AC_TileEntityFrostChest extends TileEntity implements IInventory
{
	...
	{
		return this.isInvNameLocalized() ? this.field_94045_s : "Frost Chest";
	}
	...
	public void readFromNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		if(par1NBTTagCompound.hasKey("Frost Chest"))
		{
			this.field_94045_s = par1NBTTagCompound.getString("Frost Chest");
		}
	...
	public void writeToNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		{
			par1NBTTagCompound.setString("Frost Chest", this.field_94045_s);
		}
	}
	...
	private boolean func_94044_a(int par1, int par2, int par3)
	{
		...
		return block != null && block instanceof AC_BlockFrostChest ? ((AC_BlockFrostChest) block).field_94443_a == this.func_98041_l() : false;
	}
	...
	public void updateEntity()
	{
		...
		if(! this.worldObj.isRemote && this.numUsingPlayers != 0 && (this.ticksSinceSync + this.xCoord + this.yCoord + this.zCoord) % 200 == 0)
		{
			...
			List list = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class,
					AxisAlignedBB.getAABBPool().getAABB((double) ((float) this.xCoord - f), (double) ((float) this.yCoord - f), (double) ((float) this.zCoord - f), (double) ((float) (this.xCoord + 1) + f), (double) ((float) (this.yCoord + 1) + f), (double) ((float) (this.zCoord + 1) + f)));
	...
	{
		if(this.getBlockType() != null && this.getBlockType() instanceof AC_BlockFrostChest)
		{
			--this.numUsingPlayers;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
	...
	public int func_98041_l()
	{
		...
		{
			if(this.worldObj == null || ! (this.getBlockType() instanceof AC_BlockFrostChest))
			{
				return 0;
			}

			this.field_94046_i = ((AC_BlockFrostChest) this.getBlockType()).field_94443_a;
		}

...
public class AC_ItemArmour extends ItemArmor implements IArmorTextureProvider
{
	...
	public String getArmorTextureFile(ItemStack itemstack)
	{
		...
		if(itemstack.itemID == MainRegistry.hikingBoots.itemID)
		{
			return "/mods/AC/textures/armour/hiking_boots.png";
		}
	...
	public void updateIcons(IconRegister iconRegister)
	{
		...
		if(this == MainRegistry.hikingBoots)
		{
			iconIndex = iconRegister.registerIcon("AC:hiking_boots");
		}
	}
}

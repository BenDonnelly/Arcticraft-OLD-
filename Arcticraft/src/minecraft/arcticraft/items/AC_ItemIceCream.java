...
public class AC_ItemIceCream extends ItemFood
{
	...
	private static final String[] iceCreamFlavours = {"ac:Chocolate" , "ac:Strawberry" , "ac:Vanilla" , "ac:Banana" , "ac:Raspberry" , "ac:Mint Choc Chip" , "ac:Pistachio" , "ac:Lemon Ice" , "ac:Stracciatella" , "ac:Bubblegum" ,};
	...
	{
		String[] flavours = new String[] {"Chocolate" , "Strawberry" , "Vanilla" , "Banana" , "Raspberry" , "Mint Choc Chip" , "Pistachio" , "Lemon Ice" , "Stracciatella" , "Bubblegum"};

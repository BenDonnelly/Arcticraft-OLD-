...
public class AC_Item
{
	...
	public static void initializeItems()
	{
		...
		TekkitePickaxe = new AC_ItemPickaxe(6205, TekkiteTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Tekkite Pickaxe").setTextureName("ac:tekkite_pickaxe");
		TekkiteAxe = new AC_ItemAxe(6206, TekkiteTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Tekkite Axe").setTextureName("ac:tekkite_axe");
		TekkiteHoe = new AC_ItemHoe(6207, TekkiteTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Tekkite Hoe").setTextureName("ac:tekkite_hoe");
		TekkiteSword = new AC_ItemSword(6208, TekkiteTool).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("Tekkite Sword").setTextureName("ac:tekkite_sword");
		TekkiteShovel = new AC_ItemShovel(6209, TekkiteTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Tekkite Spade").setTextureName("ac:tekkite_spade");
		...
		EscariaPickaxe = new AC_ItemPickaxe(6214, EscariaTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Escaria Pickaxe").setTextureName("ac:escaria_pickaxe");
		EscariaAxe = new AC_ItemAxe(6215, EscariaTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("escariaAxe").setTextureName("ac:escaria_axe");
		EscariaHoe = new AC_ItemHoe(6216, EscariaTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Escaria Hoe").setTextureName("ac:escaria_hoe");
		EscariaSword = new AC_ItemSword(6217, EscariaTool).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("Escaria Sword").setTextureName("ac:escaria_sword");
		EscariaShovel = new AC_ItemShovel(6218, EscariaTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Escaria Spade").setTextureName("ac:escaria_spade");
		...
		RigentemPickaxe = new AC_ItemPickaxe(6223, RigentemTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Rigentem Pickaxe").setTextureName("ac:rigentem_pickaxe");
		RigentemAxe = new AC_ItemAxe(6224, RigentemTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("rigentemAxe").setTextureName("ac:rigentem_axe");
		RigentemHoe = new AC_ItemHoe(6225, RigentemTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Rigentem Hoe").setTextureName("ac:rigentem_hoe");
		RigentemSword = new AC_ItemSword(6226, RigentemTool).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("Rigentem Sword").setTextureName("ac:rigentem_sword");
		RigentemShovel = new AC_ItemShovel(6227, RigentemTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Rigentem Spade").setTextureName("ac:rigentem_spade");
		...
		GlacianPickaxe = new AC_ItemPickaxe(6232, GlacianTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Glacian Pickaxe").setTextureName("ac:glacian_pickaxe");
		GlacianAxe = new AC_ItemAxe(6233, GlacianTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Glacian Axe").setTextureName("ac:glacian_axe");
		GlacianHoe = new AC_ItemHoe(6234, GlacianTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Glacian Hoe").setTextureName("ac:glacian_hoe");
		GlacianSword = new AC_ItemSword(6235, GlacianTool).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("Glacian Sword").setTextureName("ac:glacian_sword");
		GlacianShovel = new AC_ItemShovel(6236, GlacianTool).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Glacian Spade").setTextureName("ac:glacian_spade");
		...
		ArcticStonePickaxe = new AC_ItemPickaxe(6241, EnumToolMaterial.STONE).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Arctic Stone Pickaxe").setTextureName("ac:arctic_stone_pickaxe");
		ArcticStoneAxe = new AC_ItemAxe(6242, EnumToolMaterial.STONE).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Arctic Stone Axe").setTextureName("ac:arctic_stone_axe");
		ArcticStoneHoe = new AC_ItemHoe(6243, EnumToolMaterial.STONE).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Arctic Stone Hoe").setTextureName("ac:arctic_stone_hoe");
		ArcticStoneSword = new AC_ItemSword(6244, EnumToolMaterial.STONE).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("Arctic Stone Sword").setTextureName("ac:arctic_stone_sword");
		ArcticStoneShovel = new AC_ItemShovel(6245, EnumToolMaterial.STONE).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Arctic Stone Spade").setTextureName("ac:arctic_stone_spade");

		FrostWoodPickaxe = new AC_ItemPickaxe(6246, EnumToolMaterial.WOOD).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Frost Wood Pickaxe").setTextureName("ac:frost_wood_pickaxe");
		FrostWoodAxe = new AC_ItemAxe(6247, EnumToolMaterial.WOOD).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("frostWoodAxe").setTextureName("ac:frost_wood_axe");
		FrostWoodHoe = new AC_ItemHoe(6248, EnumToolMaterial.WOOD).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Frost Wood Hoe").setTextureName("ac:frost_wood_hoe");
		FrostWoodSword = new AC_ItemSword(6249, EnumToolMaterial.WOOD).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("Frost Wood Sword").setTextureName("ac:frost_wood_sword");
		FrostWoodShovel = new AC_ItemShovel(6250, EnumToolMaterial.WOOD).setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("Frost Wood Spade").setTextureName("ac:frost_wood_spade");

		frostSticks = new Item(6251).setCreativeTab(MainRegistry.tabMaterial).setTextureName("ac:frost_stick");
		penguinMeat = new ItemFood(6252, 4, true).setPotionEffect(Potion.hunger.id, 30, 0, 0.8F).setCreativeTab(MainRegistry.tabFood).setUnlocalizedName("penguin_meat").setTextureName("ac:penguin_meat");
		penguinMeatCooked = new ItemFood(6253, 8, true).setCreativeTab(MainRegistry.tabFood).setUnlocalizedName("penguin_meat_cooked").setTextureName("ac:penguin_meat_cooked");
		penguinFeather = new Item(6254).setCreativeTab(MainRegistry.tabMaterial).setUnlocalizedName("penguin_feather").setTextureName("ac:penguin_feather");
		tekkiteGem = new Item(6255).setCreativeTab(MainRegistry.tabMaterial).setUnlocalizedName("tekkite_gem").setTextureName("ac:tekkite_gem");
		escariaGem = new Item(6256).setCreativeTab(MainRegistry.tabMaterial).setUnlocalizedName("escaria_gem").setTextureName("ac:escaria_gem");
		frigus = new Item(6257).setCreativeTab(MainRegistry.tabMaterial).setUnlocalizedName("frigus").setTextureName("ac:frigus");
		glacianIngot = new Item(6258).setCreativeTab(MainRegistry.tabMaterial).setUnlocalizedName("glacian").setTextureName("ac:glacian_ingot");
		rigentemIngot = new Item(6259).setCreativeTab(MainRegistry.tabMaterial).setUnlocalizedName("rigentem").setTextureName("ac:rigentem_ingot");
		eriumGem = new Item(6260).setCreativeTab(MainRegistry.tabMaterial).setUnlocalizedName("erium_gem").setTextureName("ac:erium_gem");
		...
		arcaneDust = new Item(6263).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("arcaneDust").setTextureName("ac:arcane_dust");
		heatPack = new AC_ItemHeatPack(6264).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("heatpack").setTextureName("ac:heatpack");
		bomb = new AC_ItemBomb(6265).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("bomb").setTextureName("ac:bomb");
		emptyCup = new Item(6266).setMaxStackSize(8).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("empty_cup").setTextureName("ac:empty_cup");
		teaDrinks = new AC_ItemTeaDrinks(6267, 4, 1.3F, true).setCreativeTab(MainRegistry.tabFood).setUnlocalizedName("hot_chocolate").setTextureName("ac:hot_chocolate");
		pirateHat = new AC_ItemArmour(6268, PirateArmour, MainRegistry.instance.proxy.addArmor("Pirate"), 0).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("piratehaticon").setTextureName("ac:pirate_hat_icon");
		pirateSword = new AC_ItemCaptainSword(6269, EnumToolMaterial.EMERALD).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("pirateSword").setTextureName("ac:captain_sword");
		boarMeat = new ItemFood(6270, 10, true).setCreativeTab(MainRegistry.tabFood).setUnlocalizedName("boar_meat").setTextureName("ac:cooked_boar_meat");
		uncookedBoarMeat = new ItemFood(6271, 4, true).setPotionEffect(Potion.hunger.id, 30, 0, 0.8F).setCreativeTab(MainRegistry.tabFood).setUnlocalizedName("raw_boar_meat").setTextureName("ac:raw_boar_meat");
		...
		invisoStaff = new AC_ItemInvisoStaff(6273).setFull3D().setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("staff_icon").setTextureName("ac:staff_icon");
		...
		amouryKey = new Item(6276).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("amoury_key").setTextureName("ac:amoury_key");
		bucketIcyWater = new AC_ItemBucket(6277, AC_Block.acWaterFlowing.blockID).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("bucket_ice_water").setTextureName("ac:bucket_ice_water");
		bucketEmpty = new AC_ItemBucket(6278, 0).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("bucket_empty").setTextureName("ac:bucket_empty");
		MystFruit = new AC_ItemFruits(6279, 0, false).setCreativeTab(MainRegistry.tabFood).setUnlocalizedName("mystical_fruit").setTextureName("ac:mystical_fruit");
		GlacierFruit = (new AC_ItemFruits(6280, 0, false).setCreativeTab(MainRegistry.tabFood).setUnlocalizedName("glacier_fruit")).setTextureName("ac:glacier_fruit");
		IceShard = new Item(6281).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("ice_shard").setTextureName("ac:ice_shard");
		frostDoorPlace = new AC_ItemFrostDoor(6282, Material.wood).setUnlocalizedName("icedoor").setCreativeTab(MainRegistry.tabBlocks).setTextureName("ac:frost_door_icon");
		amouryDoorPlace = new AC_ItemAmouryDoor(6283, Material.wood).setUnlocalizedName("amoury_door").setCreativeTab(MainRegistry.tabBlocks).setTextureName("ac:amoury_door");
		floranSeed = new AC_ItemSeed(6284, AC_Block.floranPlant).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("floran_seed").setTextureName("ac:floran_seed");
		sled = new AC_ItemSled(6285).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("sled").setTextureName("ac:sled_icon");
		notchedPickaxe = new AC_ItemNPickaxe(6286, notchedPickaxeMaterial).setFull3D().setCreativeTab(MainRegistry.tabTools).setUnlocalizedName("notched_pickaxe").setTextureName("ac:notched_pickaxe_icon");
		ignisBlade = new AC_ItemIgnisBlade(6287, ignisBladeMaterial).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("ignis_blade").setTextureName("ac:ignis_blade");
		archerBow = new AC_ItemArchersBow(6288).setFull3D().setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("archer_bow").setTextureName("ac:archer_bow");
		captainLog = new AC_ItemCaptainLog(6289).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("captain_log").setTextureName("ac:captain_log");
		woodenClub = new AC_ItemSword(6290, EnumToolMaterial.WOOD).setCreativeTab(MainRegistry.tabCombat).setUnlocalizedName("wooden_club").setTextureName("ac:wooden_club");
		lantern = new AC_ItemBlockLantern(1516).setUnlocalizedName("lantern").setTextureName("ac:lantern");
		cannonball = new Item(1517).setFull3D().setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("cannonball").setTextureName("ac:cannonball_icon");
		pirateHook = new Item(1518).setFull3D().setUnlocalizedName("pirateHook").setTextureName("ac:pirateHook");
		jadeite = new Item(1519).setCreativeTab(MainRegistry.tabMisc).setUnlocalizedName("jadeite").setTextureName("ac:jadeite");
	}

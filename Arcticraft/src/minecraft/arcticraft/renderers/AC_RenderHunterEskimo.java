...
public class AC_RenderHunterEskimo extends RenderLiving
{
	...
	public void func_177_a(AC_EntityEskimoHunter entityeskimo, double d, double d1, double d2, float f, float f1)
	{
	...
	{
		func_177_a((AC_EntityEskimoHunter) entityliving, d, d1, d2, f, f1);
	}

	public void doRender(Entity entity, double d, double d1, double d2, float f, float f1)
	{
		func_177_a((AC_EntityEskimoHunter) entity, d, d1, d2, f, f1);
	}
